...
(cl:defmethod cl:initialize-instance :after ((m <control_message>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'control_message)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name control_publisher-msg:<control_message> is deprecated: use control_publisher-msg:control_message instead.")))
...
(cl:defmethod psi-val ((m <control_message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control_publisher-msg:psi-val is deprecated.  Use control_publisher-msg:psi instead.")
  (psi m))

(cl:ensure-generic-function 'phi-val :lambda-list '(m))
(cl:defmethod phi-val ((m <control_message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control_publisher-msg:phi-val is deprecated.  Use control_publisher-msg:phi instead.")
  (phi m))

(cl:ensure-generic-function 'theta-val :lambda-list '(m))
(cl:defmethod theta-val ((m <control_message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control_publisher-msg:theta-val is deprecated.  Use control_publisher-msg:theta instead.")
  (theta m))

(cl:ensure-generic-function 'thrust-val :lambda-list '(m))
(cl:defmethod thrust-val ((m <control_message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control_publisher-msg:thrust-val is deprecated.  Use control_publisher-msg:thrust instead.")
  (thrust m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<control_message>)))
  ...
  "control_publisher/control_message")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'control_message)))
  "Returns string type for a message object of type 'control_message"
  "control_publisher/control_message")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<control_message>)))
  ...
  "2c697d3485b94c731573007cca1e49bb")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'control_message)))
  "Returns md5sum for a message object of type 'control_message"
  "2c697d3485b94c731573007cca1e49bb")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<control_message>)))
  ...
  (cl:format cl:nil "Header header~%~%float64 psi~%float64 phi~%float64 theta~%float64 thrust~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'control_message)))
  "Returns full string definition for message of type 'control_message"
  (cl:format cl:nil "Header header~%~%float64 psi~%float64 phi~%float64 theta~%float64 thrust~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
